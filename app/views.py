...
def analyze(request):
   ...
   # LinearRegression Implementation
    ...
    df_binary = df[['N','P','K','temperautre','humidity','ph','rainfall']]
    df_binary.columns = ['N','P','K','temperautre','humidity','ph','rainfall']
    ...
    params = {'purpose':'Predicted Crop: ', 'analyzed_text': result1.upper(), 'analyzed_text2': result1.upper()}
